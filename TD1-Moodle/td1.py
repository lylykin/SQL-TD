...
def lire_fichier_csv(chemin_vers_fichier):
    ...
    with open(chemin_vers_fichier, 'r', encoding='utf-8') as fichier:
        ...
        for ligne in reader:
            nb_lignes += 1
            print(f"ligne = {ligne}")
            numero = 0  # à compléter
            mesure = 0.0  # à compléter
            # somme = ...  # à compléter
            print(f"Le capteur n°{numero} a mesuré {mesure}")

    print(f"Nombre de Lignes: {nb_lignes}")
    moyenne = 0.0  # à compléter
...
def ecrire_fichier_csv(chemin_vers_dossier):
    ...
    nom_fichier = "nombres-output_" + ""  # à compléter, sans oublier le ".csv"
    ...
    with open(chemin_vers_fichier, 'w', encoding='utf-8') as fichier:
        ...
        for i in range(250):
            ...
            # rang = ...  # à compléter
            # nombre_formate = ...  # à compléter (attention au formatage)
...
def ajouter_mesures_depuis_fichier_csv(connexion_bd, chemin_vers_fichier):
    with open(chemin_vers_fichier, 'r', encoding='utf-8') as fichier:
        ...
        for ligne in reader:
            ...
            mesure = 0.0   # à compléter
            maintenant = datetime.now()
            # ajouter_mesure(connexion_bd, ..., ..., ...)   # à compléter
